                        ...
                        <div class="blog-page__content blog-single">
                            ...
                            <div class="post">
                                ...
                                <div class="post-title">
                                    <h1>Snowbombing-2016 - Apr 4 - Apr 9, 2016, Mayrhofen, Austria</h1>
                                </div>
                                ...
                                <div class="post-body">
                                    <div class="post-content">
                                      ...
                                      <br>
                                      <p>
                                        The event has been run since 2000 when it was first held at the French resort of Risoul as an après-ski nightclub promotional exercise started by English promoters from Manchester called Outgoing Ltd.
                                        <br>
                                        <br>
                                        <img src="images/blog-img/snowbombing1.jpg" alt="">
                                        <br>
                                        <br>
                                        However, since 2005, the Tyrolean resort of Mayrhofen in Austria has hosted the festival which has evolved into Europe's biggest snow and music
                                    </p>
                                    <br>
                                    <br>
                                      <iframe width="560" height="315" src="https://www.youtube.com/embed/rXwPUzbVkpg" frameborder="0" allowfullscreen></iframe>
                                    </div>
                                </div>
