		...
		<div class="box">
			<div class="box-header with-border">
				...
				<div class="box-tools pull-right">
					<?php echo $this->Html->link('<i class="fa fa-plus"></i> Add Tour',['controller'=>'Users','action'=>'add'],['escape'=>false,'class'=>'btn btn-box-tool','data-toggle'=>'tooltip','title'=>'Add Tour']);?>
				</div>
			</div>
			<?php

			echo $this->Form->create($tour, ['type' => 'file']);?>
			<div class="box-body">
...
<!--						<div class="error-message">--><?php //echo !empty();?><!--</div>-->
					...
					<div class="form-group">
						<?php echo $this->Form->input('time',['class'=>'form-control','label'=>'Time','div'=>false]);?>
					</div>

					<div class="form-group">
						<?php echo $this->Form->input('city',['class'=>'form-control','label'=>'City','div'=>false]);?>
					</div>
                <?php
                $status='';
                switch($tour->status){
                 ...
                 echo $this->Form->input('status',['type'=>'select','options'=>['active'=>'Active','inactive'=>'Inactive', 'blocked'=>'Blocked'],'label'=>false,'div'=>false,'class'=>'form-control status','value'=>$status,'data-id'=>$tour->id]);
                ?>
					<div class="form-group">
