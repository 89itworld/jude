            ...
            <div class="category-heading-content category-heading-content__2 text-uppercase">
                <div class="find">
                   <!-- <h2 class="text-center">Find Your Flight</h2>-->
                    <?php echo $this->Form->create('flights',['method'=>'post','url'=>['contorller'=>'Flights','action'=>'round_trip']]);  ?>
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-actions">
                                    <?php echo $this->Form->input('travel_way',['type'=>'hidden','value'=>'R']); ?>
...
//                                pr($flights);
                            ...
                            <div class="flight-item">
                                ...
                                <?php $len = sizeof($flights->flight_stops);
                                foreach ($flights->flight_stops as $key => $flight_stop_details) {
                                    $len--;
                                    if ($key == 0) {
                                        $flight_stops[] = $flight_stop_details->airline_name;
                                    }
                                    if ($flight_stop_details->return_flight != 1) {
                                        if (($d == 0 && $flight_stop_details->return_flight != 1) /*|| ($r == 0 && $flight_stop_details->return_flight == 1)*/) {
                                            $d = 1; ?>
                                            ...
                                            <div class="item-title">
                                                <h2>
                                                    <?php echo $this->Html->link("Departure : ".$flights->departure_location . ' : ' . $flights->arrival_location, '#'); ?>
                                                </h2>
                                            </div>
                                    ...
                                    if ($flight_stop_details->return_flight == 1) {
                                        if ($r == 0) {
                                            ...
                                            <div class="item-media">
                                                <div class="image-cover">
                                                    <?php echo $this->Html->image('https://images.kiwi.com/airlines/64/' . @$flight_stop_details->airline_code . ".png", ['alt' => @$flight_stop_details->airline_name]); ?>
                                                </div>
                                            </div>
                                            <div class="item-body">
                                            <div class="item-title">
                                                <h2>
                                                    ...
                                                    <?php echo $this->Html->link("Return : ".$flights->arrival_location . ' : ' . $flights->departure_location, '#'); ?>
                                                </h2>
                                            </div>
                                            <table class="item-table">
                                            <thead>
