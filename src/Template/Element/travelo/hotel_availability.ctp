      ...
      //  pr($avaliability); die;
        ...
        <article class="box">
            <figure class="col-sm-4 col-md-3">
                    ...
                    foreach(@$image['HotelRoomImageResponse']['RoomImages']['RoomImage'] as $roomImages){
                            if($roomImages['roomTypeCode'] == $avaliability['roomTypeCode']){
                                $bedImage = str_replace("http://media.expedia.com","https://exp.cdn-hotels.com", $roomImages['url']);
                            } ?>
                   <?php }?>
                    <img width="230" height="160" src="<?php echo $bedImage; ?>" alt="">
