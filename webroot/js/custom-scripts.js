 $(function(){
    ...
    ***************************************/
    ...
    $(document).ready(function() {
        ...
        //var top = Math.max($(window).height() / 2.4 - $("#header_body")[0].offsetHeight / 2, 0);
        /*var top = '10%';
        $("#header_body").css('padding-top', top ).css('padding-bottom',top );
    ...
    /**********************************************************/
    function init_map() {
        var myLocation = new google.maps.LatLng(40.730610,-73.935242);
...
//show hide list view page items

    $(".prlist-view").click(function(){
        $(".prgrid-view2").show();
		$(".prlist-view1").hide();
    });
    $(".prgrid-view").click(function(){
        $(".prlist-view1").show();
		$(".prgrid-view2").hide();
    });
